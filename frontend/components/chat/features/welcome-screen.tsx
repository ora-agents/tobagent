          ...
          <div className="relative">
            ...
            <div className="flex items-end gap-2 px-3 py-1.5">
              ...
              <Textarea
                ...
                className="scrollbar-none relative z-10 min-h-[36px] max-h-[240px] resize-none bg-transparent w-full px-3 py-2 text-sm leading-relaxed text-foreground placeholder:text-muted-foreground focus-visible:bg-transparent focus-visible:ring-0 focus-visible:ring-offset-0 transition-all duration-200 break-words"
                disabled={isLoading || !userId || isAgentLoading || !hasActiveAgent}
                rows={1}
              />
