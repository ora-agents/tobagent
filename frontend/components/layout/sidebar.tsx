  ...
  return (
    <>
      <aside
        className={
          isMobileDrawer
            ? "flex h-dvh w-[min(20rem,calc(100vw-2rem))] flex-col overflow-hidden border-r border-sidebar-border/60 bg-sidebar text-sidebar-foreground shadow-depth-lg"
            : "hidden w-56 flex-col border-r border-sidebar-border/60 bg-sidebar text-sidebar-foreground md:flex"
        }
      >
