...
const zh = {
  ...
  signInAccessDesc: "登录威思瑞客服智能体平台，定义企业专属客服 Agent 工作台",
  registerAccessDesc: "创建账号，开始配置你的自定义 Agent、知识库和工具流程",
  loginBrandName: "威思瑞客服智能体平台",
  loginBrandSub: "自定义客服 Agent 产品工作台",
  loginSubmit: "登录威思瑞客服智能体平台",
  ...
  smsAuthUnavailable: "短信服务未配置，注册和手机号安全操作已关闭。",
  traceBrowserUnavailable: "Langfuse 未配置，轨迹浏览已关闭。",
  authErrorInvalidCredentials: "用户名或密码不正确。",
  authErrorInvalidSmsCode: "验证码不正确或已过期。",
  authErrorUsernameExists: "该用户名已存在，请更换后重试。",
  authErrorPhoneExists: "该手机号已注册，请直接登录。",
  authErrorPhoneNotRegistered: "该手机号尚未注册，请先创建账号。",
  authErrorPhoneAlreadyBound: "当前账号已绑定手机号。",
  authErrorPhoneNotBound: "当前账号尚未绑定手机号。",
  authErrorSmsTooFrequent: "验证码发送过于频繁，请稍后再试。",
  authErrorAuthenticationRequired: "登录状态已失效，请重新登录。",
  authErrorInvalidUser: "当前用户无效，请重新登录。",
  authErrorNetwork: "无法连接服务器，请检查网络或稍后重试。",
  authErrorInvalidRequest: "请求内容不正确，请检查后重试。",
  authErrorField: "字段",
  authErrorFieldRequired: "请填写{field}。",
  authErrorFieldInvalid: "{field}格式不正确。",
  notLoggedIn: "未登录",
  serverError: "服务器错误",
...
const en = {
  ...
  signInAccessDesc: "Sign in to the WSIRI customer service agent platform and enter your dedicated customer service agent workspace",
  registerAccessDesc: "Create an account to configure custom agents, knowledge bases, and tool workflows",
  loginBrandName: "WSIRI Customer Service Agent Platform",
  loginBrandSub: "Custom customer service agent product workspace",
  loginSubmit: "Sign in to WSIRI customer service agent platform",
  ...
  register: "Register",
  username: "Username",
  accountOrPhone: "Account or phone",
  password: "Password",
  email: "Email",
  phone: "Phone",
  ...
  enterAccountOrPhone: "Enter account or phone",
  ...
  smsAuthUnavailable: "SMS is not configured. SMS-backed registration and phone security actions are disabled.",
  traceBrowserUnavailable: "Langfuse is not configured. Trace browsing is disabled.",
  authErrorInvalidCredentials: "Invalid username or password.",
  authErrorInvalidSmsCode: "The verification code is invalid or expired.",
  authErrorUsernameExists: "This username already exists. Please choose another one.",
  authErrorPhoneExists: "This phone number is already registered. Please sign in.",
  authErrorPhoneNotRegistered: "This phone number is not registered. Please create an account first.",
  authErrorPhoneAlreadyBound: "This account already has a bound phone number.",
  authErrorPhoneNotBound: "This account does not have a bound phone number.",
  authErrorSmsTooFrequent: "Verification code requests are too frequent. Please try again later.",
  authErrorAuthenticationRequired: "Your session has expired. Please sign in again.",
  authErrorInvalidUser: "The current user is invalid. Please sign in again.",
  authErrorNetwork: "Unable to reach the server. Check your connection and try again.",
  authErrorInvalidRequest: "The request is invalid. Please check your input and try again.",
  authErrorField: "Field",
  authErrorFieldRequired: "Please enter {field}.",
  authErrorFieldInvalid: "{field} is invalid.",
