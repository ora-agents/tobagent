...
const zh = {
  ...
  mcpCommunityRecommendations: "可前往 ModelScope MCP 社区发现推荐的 MCP 服务：",
  ...
  resetPasswordDesc: "通过绑定手机号接收验证码，重新设置你的登录密码",
...
const en = {
  ...
  mcpCommunityRecommendations: "Discover recommended MCP servers in the ModelScope MCP community:",
  ...
  resetPasswordDesc: "Receive a verification code on your bound phone and set a new sign-in password",
